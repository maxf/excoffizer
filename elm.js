...
var author$project$Model$initialParams = {contrast: 0, line_height: 5.0, opacity: 30.0, output_height: 400, sx: 10.0, sy: 10.0, theta: 30.0, tx: 0.0, ty: 0.0, waviness: 10.0};
var author$project$Model$initialModel = {advancedOptionsOpen: true, mdc: author$project$Material$defaultModel, params: author$project$Model$initialParams};
var author$project$Types$Mdc = function (a) {
	return {$: 'Mdc', a: a};
};
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		...
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					author$project$Material$init(author$project$Types$Mdc)
				])));
};
...
var author$project$Ports$newImageLoaded = _Platform_incomingPort('newImageLoaded', elm$json$Json$Decode$bool);
var author$project$Ports$renderDone = _Platform_incomingPort('renderDone', elm$json$Json$Decode$bool);
var author$project$Types$NewImageLoaded = function (a) {
	return {$: 'NewImageLoaded', a: a};
};
var author$project$Types$RenderFinished = function (a) {
	return {$: 'RenderFinished', a: a};
};
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(author$project$Material$subscriptions, author$project$Types$Mdc, model),
				author$project$Ports$renderDone(author$project$Types$RenderFinished),
				author$project$Ports$newImageLoaded(author$project$Types$NewImageLoaded)
			]));
};
...
var author$project$Internal$Snackbar$Implementation$toast = F2(
	function (onDismiss, message) {
		return {action: elm$core$Maybe$Nothing, actionOnBottom: false, dismissOnAction: true, fade: 250, message: message, multiline: false, onDismiss: onDismiss, timeout: 2750};
	});
var author$project$Material$Snackbar$toast = author$project$Internal$Snackbar$Implementation$toast;
var author$project$Model$withContrast = F2(
	function (newContrast, model) {
		var params = model.params;
		return _Utils_update(
			model,
			{
				params: _Utils_update(
					params,
					{contrast: newContrast})
			});
	});
var author$project$Model$withLineHeight = F2(
	function (newHeight, model) {
		...
		return _Utils_update(
			model,
			{
				params: _Utils_update(
					params,
					{line_height: newHeight})
			});
	});
var author$project$Model$withOpacity = F2(
	function (newOpacity, model) {
		var params = model.params;
		return _Utils_update(
			model,
			{
...
var author$project$Model$withStretchX = F2(
	function (newStretchX, model) {
		var params = model.params;
		return _Utils_update(
			model,
			{
...
var author$project$Model$withStretchY = F2(
	function (newStretchY, model) {
		var params = model.params;
		return _Utils_update(
			model,
			{
...
var author$project$Model$withTheta = F2(
	function (newTheta, model) {
		var params = model.params;
		return _Utils_update(
			model,
			{
...
var author$project$Model$withWaviness = F2(
	function (newWaviness, model) {
		var params = model.params;
		return _Utils_update(
			model,
			{
...
var author$project$Ports$render = _Platform_outgoingPort(
	'render',
	function ($) {
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'contrast',
					elm$json$Json$Encode$float($.contrast)),
					_Utils_Tuple2(
					'line_height',
					elm$json$Json$Encode$float($.line_height)),
					_Utils_Tuple2(
					'opacity',
					elm$json$Json$Encode$float($.opacity)),
					_Utils_Tuple2(
					'output_height',
					elm$json$Json$Encode$int($.output_height)),
					_Utils_Tuple2(
					'sx',
					...
					_Utils_Tuple2(
					'tx',
					elm$json$Json$Encode$float($.tx)),
					_Utils_Tuple2(
					'ty',
					elm$json$Json$Encode$float($.ty)),
					_Utils_Tuple2(
					'waviness',
					elm$json$Json$Encode$float($.waviness))
				]));
	});
var author$project$Update$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AdvancedSettingsButtonClicked':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{advancedOptionsOpen: !model.advancedOptionsOpen}),
					elm$core$Platform$Cmd$none);
			case 'RenderButtonClicked':
				return _Utils_Tuple2(
					model,
					author$project$Ports$render(model.params));
			case 'RenderFinished':
				var success = msg.a;
				if (success) {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				} else {
					var contents = A2(author$project$Material$Snackbar$toast, elm$core$Maybe$Nothing, 'Rendering error');
					var _n1 = A4(author$project$Material$Snackbar$add, author$project$Types$Mdc, 'my-snackbar', contents, model.mdc);
					var mdc = _n1.a;
					var effects = _n1.b;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'UserChangedTheta':
				var newTheta = msg.a;
				var newModel = A2(author$project$Model$withTheta, newTheta, model);
				return _Utils_Tuple2(
					newModel,
					author$project$Ports$render(newModel.params));
			case 'UserChangedWaviness':
				var newWaviness = msg.a;
				var newModel = A2(author$project$Model$withWaviness, newWaviness, model);
				return _Utils_Tuple2(
					newModel,
					author$project$Ports$render(newModel.params));
			case 'UserChangedLineHeight':
				var newLineHeight = msg.a;
				var newModel = A2(author$project$Model$withLineHeight, newLineHeight, model);
				return _Utils_Tuple2(
					newModel,
					author$project$Ports$render(newModel.params));
			case 'UserChangedStretchX':
				var newStretchX = msg.a;
				var newModel = A2(author$project$Model$withStretchX, newStretchX, model);
				return _Utils_Tuple2(
					newModel,
					author$project$Ports$render(newModel.params));
			case 'UserChangedStretchY':
				var newStretchY = msg.a;
				var newModel = A2(author$project$Model$withStretchY, newStretchY, model);
				return _Utils_Tuple2(
					newModel,
					author$project$Ports$render(newModel.params));
			case 'UserChangedOpacity':
				var newOpacity = msg.a;
				var newModel = A2(author$project$Model$withOpacity, newOpacity, model);
				return _Utils_Tuple2(
					newModel,
					author$project$Ports$render(newModel.params));
			case 'UserChangedContrast':
				var newContrast = msg.a;
				var newModel = A2(author$project$Model$withContrast, newContrast, model);
				return _Utils_Tuple2(
					newModel,
					author$project$Ports$render(newModel.params));
			case 'NewImageLoaded':
			...
			default:
				var msg_ = msg.a;
				return A3(author$project$Material$update, author$project$Types$Mdc, msg_, model);
		}
	});
...
var author$project$Internal$Button$Implementation$defaultConfig = {disabled: false, icon: elm$core$Maybe$Nothing, link: elm$core$Maybe$Nothing, onClick: elm$core$Maybe$Nothing, ripple: false};
			...
			elm$core$String$concat(
				_List_fromArray(
					[
						...
						elm$core$String$fromFloat(unboundedCoords.top),
						elm$core$String$fromFloat(unboundedCoords.left),
						translateStart,
						translateEnd
					])));
				...
				elm$core$List$concat(
					_List_fromArray(
						[
							_List_fromArray(
							[
								_Utils_Tuple2(author$project$Internal$Ripple$Model$strings.varFgSize, fgSize),
								_Utils_Tuple2(
							...
							[
								_Utils_Tuple2(author$project$Internal$Ripple$Model$strings.varFgTranslateStart, translateStart),
								_Utils_Tuple2(author$project$Internal$Ripple$Model$strings.varFgTranslateEnd, translateEnd)
							])
						]))));
...
var author$project$Internal$Ripple$Implementation$defaultConfig = {color: elm$core$Maybe$Nothing};
...
var author$project$Internal$Ripple$Model$cssClasses = {bgFocused: 'mdc-ripple-upgraded--background-focused', fgActivation: 'mdc-ripple-upgraded--foreground-activation', fgDeactivation: 'mdc-ripple-upgraded--foreground-deactivation', root: 'mdc-ripple-upgraded', unbounded: 'mdc-rippe-upgraded--unbounded'};
...
var author$project$Internal$Ripple$Implementation$view = F5(
	function (isUnbounded, domId, lift, model, options) {
							...
							author$project$Internal$Ripple$Implementation$decodeActivate(
								{
									...
									isActivated: function () {
										var _n2 = model.animationState;
										if (_n2.$ === 'Activated') {
											var activationState = _n2.a;
									...
									previousActivationEvent: function () {
										...
										if (_n3.$ === 'Activated') {
											var activationEvent = _n3.a.activationEvent;
		...
		var _n0 = A2(author$project$Internal$Options$collect, author$project$Internal$Ripple$Implementation$defaultConfig, options);
		var config = _n0.config;
		var _n1 = model.animationState;
		switch (_n1.$) {
			case 'Idle':
				var style = noStyle;
			...
			case 'Activated':
				...
				var cssVars = A2(
					...
					isUnbounded,
					{
						...
						fgSize: elm$core$String$fromFloat(activatedData.initialSize) + 'px',
				...
				var properties = author$project$Internal$Options$many(
					_List_fromArray(
						[
							baseProperties,
							author$project$Internal$Options$cs(cssVars.className),
				...
				var style = A3(
					...
					_List_fromArray(
						[
							elm$html$Html$text(cssVars.text)
						]));
				return {interactionHandler: interactionHandler, properties: properties, style: style};
			default:
				var activatedData = _n1.a;
...
var author$project$Types$AdvancedSettingsButtonClicked = {$: 'AdvancedSettingsButtonClicked'};
...
var author$project$Internal$Slider$Implementation$max = function (value_) {
...
var author$project$Material$Slider$max = author$project$Internal$Slider$Implementation$max;
var author$project$Internal$Slider$Implementation$min = function (value_) {
	return author$project$Internal$Options$option(
		function (config) {
			return _Utils_update(
				config,
...
var author$project$Material$Slider$min = author$project$Internal$Slider$Implementation$min;
var author$project$Internal$Slider$Implementation$onChange = function (handler) {
	return author$project$Internal$Options$option(
		function (config) {
			return _Utils_update(
				config,
				{
					onChange: elm$core$Maybe$Just(handler)
				});
		});
};
var author$project$Material$Slider$onChange = author$project$Internal$Slider$Implementation$onChange;
...
var author$project$Material$Slider$step = author$project$Internal$Slider$Implementation$step;
var author$project$Internal$Slider$Implementation$value = function (value_) {
	return author$project$Internal$Options$option(
		function (config) {
			return _Utils_update(
				config,
...
var author$project$DOM$offsetLeft = A2(elm$json$Json$Decode$field, 'offsetLeft', elm$json$Json$Decode$float);
...
var author$project$Internal$Slider$Implementation$hasClass = function (_class) {
	return A2(
		elm$json$Json$Decode$map,
		function (className) {
...
var author$project$Internal$Slider$Implementation$decodeGeometry = function () {
	var traverseToContainer = function (decoder) {
		return A2(
			elm$json$Json$Decode$andThen,
			function (doesHaveClass) {
				return doesHaveClass ? decoder : author$project$DOM$parentElement(
					elm$json$Json$Decode$lazy(
						function (_n0) {
							return traverseToContainer(decoder);
						}));
			},
			author$project$Internal$Slider$Implementation$hasClass('mdc-slider'));
	};
				...
				F6(
					function (offsetWidth, offsetLeft, decodedDiscrete, decodedMin, decodedMax, decodedStep) {
						return {
							...
							max: decodedMax,
							min: decodedMin,
							rect: {left: offsetLeft, width: offsetWidth},
							step: decodedStep
						};
					}),
				author$project$DOM$offsetWidth,
				author$project$DOM$offsetLeft,
				author$project$Internal$Slider$Implementation$hasClass('mdc-slider--discrete'),
				A2(
					author$project$Internal$Slider$Implementation$data,
					'min',
					A2(
						elm$json$Json$Decode$map,
						A2(
...
var author$project$Internal$Slider$Implementation$defaultConfig = {discrete: false, max: 100, min: 0, onChange: elm$core$Maybe$Nothing, onInput: elm$core$Maybe$Nothing, step: 1, trackMarkers: false, value: 0};
...
var author$project$Internal$Slider$Implementation$discretize = F2(
	function (geometry, continuousValue) {
		var steps = function (steps_) {
			...
			A2(elm$core$Maybe$withDefault, 1, geometry.step));
		var continuous = !geometry.discrete;
		return A3(
			...
			function () {
				if (continuous) {
					...
					var numSteps = elm$core$Basics$round(continuousValue / steps);
					var quantizedVal = numSteps * steps;
					return quantizedVal;
				}
			}());
	});
var author$project$Internal$Slider$Implementation$valueForKey = F4(
	function (key, keyCode, geometry, currentValue) {
		var pageFactor = 4;
		var isRtl = false;
		var isPageUp = _Utils_eq(
			key,
			elm$core$Maybe$Just('PageUp')) || (keyCode === 33);
		var isPageDown = _Utils_eq(
			key,
			elm$core$Maybe$Just('PageDown')) || (keyCode === 34);
		var isHome = _Utils_eq(
			key,
			elm$core$Maybe$Just('Home')) || (keyCode === 36);
		var isEnd = _Utils_eq(
			key,
			elm$core$Maybe$Just('End')) || (keyCode === 35);
		var isArrowUp = _Utils_eq(
			key,
			elm$core$Maybe$Just('ArrowUp')) || (keyCode === 38);
		var isArrowRight = _Utils_eq(
			key,
			elm$core$Maybe$Just('ArrowRight')) || (keyCode === 39);
		var isArrowLeft = _Utils_eq(
			key,
			elm$core$Maybe$Just('ArrowLeft')) || (keyCode === 37);
		var isArrowDown = _Utils_eq(
			key,
		...
		var delta = ((isRtl && (isArrowLeft || isArrowRight)) ? elm$core$Basics$mul(-1) : elm$core$Basics$identity)(
			geometry.discrete ? A2(elm$core$Maybe$withDefault, 1, geometry.step) : ((geometry.max - geometry.min) / 100));
		return A2(
			elm$core$Maybe$map,
			A2(elm$core$Basics$clamp, geometry.min, geometry.max),
			(isArrowLeft || isArrowDown) ? elm$core$Maybe$Just(currentValue - delta) : ((isArrowRight || isArrowUp) ? elm$core$Maybe$Just(currentValue + delta) : (isHome ? elm$core$Maybe$Just(geometry.min) : (isEnd ? elm$core$Maybe$Just(geometry.max) : (isPageUp ? elm$core$Maybe$Just(currentValue + (delta * pageFactor)) : (isPageDown ? elm$core$Maybe$Just(currentValue - (delta * pageFactor)) : elm$core$Maybe$Nothing))))));
	});
var author$project$Internal$Slider$Model$Blur = {$: 'Blur'};
var author$project$Internal$Slider$Model$Drag = function (a) {
	return {$: 'Drag', a: a};
};
var author$project$Internal$Slider$Model$Focus = {$: 'Focus'};
var author$project$Internal$Slider$Model$InteractionStart = F2(
	function (a, b) {
		return {$: 'InteractionStart', a: a, b: b};
	});
var author$project$Internal$Slider$Model$KeyDown = {$: 'KeyDown'};
var author$project$Internal$Slider$Model$NoOp = {$: 'NoOp'};
var author$project$Internal$Slider$Model$Resize = function (a) {
	return {$: 'Resize', a: a};
};
var author$project$Internal$Slider$Model$ThumbContainerPointer = F2(
	function (a, b) {
		return {$: 'ThumbContainerPointer', a: a, b: b};
	});
var author$project$Internal$Slider$Model$TransitionEnd = {$: 'TransitionEnd'};
var author$project$Internal$Slider$Model$Up = {$: 'Up'};
...
var author$project$Internal$Slider$Implementation$slider = F4(
	function (lift, model, options, _n0) {
		var ups = _List_fromArray(
		...
		var config = summary.config;
		var continuousValue = model.active ? A2(elm$core$Maybe$withDefault, config.value, model.activeValue) : config.value;
		...
		var stepChanged = !_Utils_eq(
			elm$core$Maybe$Just(config.step),
			A2(
				elm$core$Maybe$andThen,
				function ($) {
					return $.step;
				...
				model.geometry));
		var trackScale = (!(config.max - config.min)) ? 0 : ((discreteValue - config.min) / (config.max - config.min));
		var translateX = function () {
			var v = A3(elm$core$Basics$clamp, config.min, config.max, discreteValue);
			var c = (config.max - config.min) ? A3(elm$core$Basics$clamp, 0, 1, (v - config.min) / (config.max - config.min)) : 0;
		...
		return A3(
			...
			_List_fromArray(
				[
					author$project$Internal$Options$cs('elm-mdc-slider-wrapper'),
					A2(
					...
					A2(
						elm$json$Json$Decode$map,
						function (message) {
							return {message: message, preventDefault: true, stopPropagation: false};
						},
						A2(
							elm$json$Json$Decode$map,
							lift,
								...
								A3(
									...
									F2(
										function (key, keyCode) {
											var activeValue = A4(author$project$Internal$Slider$Implementation$valueForKey, key, keyCode, geometry, config.value);
				...
				[
					...
					_List_fromArray(
						[
							...
							author$project$Internal$Options$when,
							model.active,
							author$project$Internal$Options$cs('mdc-slider--active')),
							A2(
							author$project$Internal$Options$when,
							_Utils_cmp(discreteValue, config.min) < 1,
							...
							author$project$Internal$Options$role('slider'),
							A2(
							...
							A2(
							author$project$Internal$Options$when,
							_Utils_eq(model.geometry, elm$core$Maybe$Nothing) || stepChanged,
							author$project$Internal$GlobalEvents$onTick(
								A2(
									elm$json$Json$Decode$map,
									A2(elm$core$Basics$composeL, lift, author$project$Internal$Slider$Model$Init),
									author$project$Internal$Slider$Implementation$decodeGeometry))),
							author$project$Internal$GlobalEvents$onResize(
							A2(
								elm$json$Json$Decode$map,
								A2(elm$core$Basics$composeL, lift, author$project$Internal$Slider$Model$Resize),
								author$project$Internal$Slider$Implementation$decodeGeometry)),
							A2(
							author$project$Internal$Options$on,
							'keydown',
							...
							A2(
							author$project$Internal$Options$when,
							!_Utils_eq(config.onChange, elm$core$Maybe$Nothing),
							A2(
								author$project$Internal$Options$on,
								'keydown',
								A3(
									...
									F2(
										function (key, keyCode) {
											var activeValue = A2(
												...
												A4(author$project$Internal$Slider$Implementation$valueForKey, key, keyCode, geometry, config.value));
											return A2(
												elm$core$Maybe$withDefault,
												lift(author$project$Internal$Slider$Model$NoOp),
												A3(elm$core$Maybe$map2, elm$core$Basics$apL, config.onChange, activeValue));
										}),
									elm$json$Json$Decode$oneOf(
										_List_fromArray(
											[
							...
							A2(
							author$project$Internal$Options$when,
							!_Utils_eq(config.onInput, elm$core$Maybe$Nothing),
							A2(
								author$project$Internal$Options$on,
								'keydown',
								A3(
									...
									F2(
										function (key, keyCode) {
											...
											return A2(
												elm$core$Maybe$withDefault,
												lift(author$project$Internal$Slider$Model$NoOp),
												A3(elm$core$Maybe$map2, elm$core$Basics$apL, config.onInput, activeValue));
										}),
									elm$json$Json$Decode$oneOf(
										_List_fromArray(
											[
							...
							'focus',
							elm$json$Json$Decode$succeed(
								lift(author$project$Internal$Slider$Model$Focus))),
							A2(
							author$project$Internal$Options$on,
							'blur',
							elm$json$Json$Decode$succeed(
											...
											A2(
												...
												function (_n1) {
													...
													var activeValue = A2(
														...
														geometry,
														A2(author$project$Internal$Slider$Implementation$valueFromPageX, geometry, pageX));
													return A2(
														elm$core$Maybe$withDefault,
														lift(author$project$Internal$Slider$Model$NoOp),
														A2(
													...
													return A2(
														...
														A2(
															...
															function (inputHandler) {
																return inputHandler(activeValue);
															},
															config.onInput));
												},
												author$project$Internal$Slider$Implementation$decodePageX));
							...
							A2(
								...
								function (handler) {
									return handler(
										elm$json$Json$Decode$succeed(
											lift(author$project$Internal$Slider$Model$Up)));
								},
								ups)),
							A2(
							author$project$Internal$Options$when,
							(!_Utils_eq(config.onChange, elm$core$Maybe$Nothing)) && model.active,
							author$project$Internal$Options$many(
								A2(
									elm$core$List$map,
									function (handler) {
							...
							A2(
							author$project$Internal$Options$when,
							(!_Utils_eq(config.onInput, elm$core$Maybe$Nothing)) && model.active,
							author$project$Internal$Options$many(
								A2(
									elm$core$List$map,
									function (handler) {
								...
								A2(
									...
									function (handler) {
										return handler(
											A2(
												elm$json$Json$Decode$map,
												A2(elm$core$Basics$composeL, lift, author$project$Internal$Slider$Model$Drag),
												author$project$Internal$Slider$Implementation$decodePageX));
									},
									moves))),
							A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									author$project$Internal$Options$cs('mdc-slider__track-container')
								]),
							elm$core$List$concat(
								_List_fromArray(
									[
										...
										[
											...
											_List_fromArray(
												[
													author$project$Internal$Options$cs('mdc-slider__track'),
													A2(
													author$project$Internal$Options$css,
													'transform',
													'scaleX(' + (elm$core$String$fromFloat(trackScale) + ')'))
												]),
											_List_Nil)
										]),
										config.discrete ? _List_fromArray(
										[
											A3(
											author$project$Internal$Options$styled,
											elm$html$Html$div,
											_List_fromArray(
												[
													author$project$Internal$Options$cs('mdc-slider__track-marker-container')
												]),
											A2(
												elm$core$List$repeat,
												elm$core$Basics$round((config.max - config.min) / config.step),
												A3(
													author$project$Internal$Options$styled,
													elm$html$Html$div,
													_List_fromArray(
														[
															author$project$Internal$Options$cs('mdc-slider__track-marker')
														]),
													_List_Nil)))
										]) : _List_Nil
									]))),
							...
							_List_fromArray(
								[
									...
									'transitionend',
									elm$json$Json$Decode$succeed(
										lift(author$project$Internal$Slider$Model$TransitionEnd))),
									A2(
									author$project$Internal$Options$css,
									'transform',
									'translateX(' + (elm$core$String$fromFloat(translateX) + 'px) translateX(-50%)'))
								]),
							elm$core$List$concat(
								_List_fromArray(
									[
										...
										[
											...
											_List_fromArray(
												[
													author$project$Internal$Options$cs('mdc-slider__focus-ring')
												]),
											_List_Nil)
										]),
										config.discrete ? _List_fromArray(
										[
											...
											_List_fromArray(
												[
													author$project$Internal$Options$cs('mdc-slider__pin')
												]),
											_List_fromArray(
												[
													A3(
													...
													_List_fromArray(
														[
															author$project$Internal$Options$cs('mdc-slider__pin-value-marker')
														]),
													_List_fromArray(
														[
															elm$html$Html$text(
...
var author$project$Internal$Slider$Implementation$view = A3(author$project$Internal$Component$render, author$project$Internal$Slider$Implementation$getSet.get, author$project$Internal$Slider$Implementation$slider, author$project$Internal$Msg$SliderMsg);
var author$project$Material$Slider$view = author$project$Internal$Slider$Implementation$view;
var author$project$Types$UserChangedContrast = function (a) {
	return {$: 'UserChangedContrast', a: a};
};
var author$project$Types$UserChangedLineHeight = function (a) {
	return {$: 'UserChangedLineHeight', a: a};
};
var author$project$Types$UserChangedOpacity = function (a) {
	return {$: 'UserChangedOpacity', a: a};
};
var author$project$Types$UserChangedStretchX = function (a) {
	return {$: 'UserChangedStretchX', a: a};
};
var author$project$Types$UserChangedStretchY = function (a) {
	return {$: 'UserChangedStretchY', a: a};
};
var author$project$Types$UserChangedTheta = function (a) {
	return {$: 'UserChangedTheta', a: a};
};
var author$project$Types$UserChangedWaviness = function (a) {
	return {$: 'UserChangedWaviness', a: a};
};
var author$project$View$viewAdvancedOptions = function (model) {
	return _List_fromArray(
		[
			A2(
			elm$html$Html$span,
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					'Angle: ' + elm$core$String$fromFloat(model.params.theta))
				])),
			A5(
			author$project$Material$Slider$view,
			author$project$Types$Mdc,
			'theta-slider',
			model.mdc,
			_List_fromArray(
				[
					author$project$Material$Slider$value(model.params.theta),
					author$project$Material$Slider$min(0),
					author$project$Material$Slider$max(359),
					author$project$Material$Slider$discrete,
					author$project$Material$Slider$step(1.0),
					author$project$Material$Slider$onChange(author$project$Types$UserChangedTheta)
				]),
			_List_Nil),
			A2(
			elm$html$Html$span,
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					'Waviness: ' + elm$core$String$fromFloat(model.params.waviness))
				])),
			A5(
			author$project$Material$Slider$view,
			author$project$Types$Mdc,
			...
			_List_fromArray(
				[
					author$project$Material$Slider$value(model.params.waviness),
					author$project$Material$Slider$min(0),
					author$project$Material$Slider$max(30),
					author$project$Material$Slider$discrete,
					author$project$Material$Slider$step(1.0),
					author$project$Material$Slider$onChange(author$project$Types$UserChangedWaviness)
				]),
			_List_Nil),
			A2(
			elm$html$Html$span,
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					'Line height: ' + elm$core$String$fromFloat(model.params.line_height))
				])),
			A5(
			author$project$Material$Slider$view,
			author$project$Types$Mdc,
			...
			_List_fromArray(
				[
					author$project$Material$Slider$value(model.params.line_height),
					author$project$Material$Slider$min(1),
					author$project$Material$Slider$max(30),
					author$project$Material$Slider$discrete,
					author$project$Material$Slider$step(1.0),
					author$project$Material$Slider$onChange(author$project$Types$UserChangedLineHeight)
				]),
			_List_Nil),
			A2(
			elm$html$Html$span,
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					'Stretch X: ' + elm$core$String$fromFloat(model.params.sx))
				])),
			A5(
			author$project$Material$Slider$view,
			author$project$Types$Mdc,
			...
			_List_fromArray(
				[
					author$project$Material$Slider$value(model.params.sx),
					author$project$Material$Slider$min(0),
					author$project$Material$Slider$max(20),
					author$project$Material$Slider$discrete,
					author$project$Material$Slider$step(1),
					author$project$Material$Slider$onChange(author$project$Types$UserChangedStretchX)
				]),
			_List_Nil),
			A2(
			elm$html$Html$span,
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					'Stretch Y: ' + elm$core$String$fromFloat(model.params.sy))
				])),
			A5(
			author$project$Material$Slider$view,
			author$project$Types$Mdc,
			...
			_List_fromArray(
				[
					author$project$Material$Slider$value(model.params.sy),
					author$project$Material$Slider$min(0),
					author$project$Material$Slider$max(20),
					author$project$Material$Slider$discrete,
					author$project$Material$Slider$step(1),
					author$project$Material$Slider$onChange(author$project$Types$UserChangedStretchY)
				]),
			_List_Nil),
			A2(
			elm$html$Html$span,
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					'Opacity: ' + elm$core$String$fromFloat(model.params.opacity))
				])),
			A5(
			author$project$Material$Slider$view,
			author$project$Types$Mdc,
			...
			_List_fromArray(
				[
					author$project$Material$Slider$value(model.params.opacity),
					author$project$Material$Slider$min(0),
					author$project$Material$Slider$max(255),
					author$project$Material$Slider$discrete,
					author$project$Material$Slider$step(1),
					author$project$Material$Slider$onChange(author$project$Types$UserChangedOpacity)
				]),
			_List_Nil),
			A2(
			elm$html$Html$span,
			...
			_List_fromArray(
				[
					elm$html$Html$text(
					'Contrast: ' + elm$core$String$fromFloat(model.params.contrast))
				])),
			A5(
			author$project$Material$Slider$view,
			author$project$Types$Mdc,
			...
			_List_fromArray(
				[
					author$project$Material$Slider$value(model.params.contrast),
					author$project$Material$Slider$min(-255),
					author$project$Material$Slider$max(255),
					author$project$Material$Slider$discrete,
					author$project$Material$Slider$step(1),
					author$project$Material$Slider$onChange(author$project$Types$UserChangedContrast)
				]),
			_List_Nil)
		]);
};
var author$project$View$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A5(author$project$Material$Snackbar$view, author$project$Types$Mdc, 'my-snackbar', model.mdc, _List_Nil, _List_Nil),
				A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								author$project$Material$Options$onClick(author$project$Types$AdvancedSettingsButtonClicked)
							]),
						_List_fromArray(
							[
						...
						elm$html$Html$div,
						_List_Nil,
						model.advancedOptionsOpen ? author$project$View$viewAdvancedOptions(model) : _List_Nil)
					]))
			]));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Types.Msg","aliases":{"Material.Msg":{"args":["m"],"type":"Internal.Msg.Msg m"},"Internal.Index.Index":{"args":[],"type":"String.String"},"Internal.GridList.Model.Geometry":{"args":[],"type":"{ width : Basics.Float, tileWidth : Basics.Float }"},"Internal.Menu.Model.Geometry":{"args":[],"type":"{ viewport : Internal.Menu.Model.Viewport, viewportDistance : Internal.Menu.Model.ViewportDistance, anchor : { width : Basics.Float, height : Basics.Float }, menu : { width : Basics.Float, height : Basics.Float } }"},"Internal.Menu.Model.Key":{"args":[],"type":"String.String"},"Internal.Menu.Model.KeyCode":{"args":[],"type":"Basics.Int"},"Internal.Menu.Model.Meta":{"args":[],"type":"{ altKey : Basics.Bool, ctrlKey : Basics.Bool, metaKey : Basics.Bool, shiftKey : Basics.Bool }"},"Internal.Menu.Model.Viewport":{"args":[],"type":"{ width : Basics.Float, height : Basics.Float }"},"Internal.Menu.Model.ViewportDistance":{"args":[],"type":"{ top : Basics.Float, right : Basics.Float, left : Basics.Float, bottom : Basics.Float }"},"Internal.Ripple.Model.ActivateData":{"args":[],"type":"{ event : Internal.Ripple.Model.Event, isSurfaceDisabled : Basics.Bool, wasElementMadeActive : Basics.Bool, isUnbounded : Basics.Bool }"},"Internal.Ripple.Model.Event":{"args":[],"type":"{ eventType : String.String, pagePoint : { pageX : Basics.Float, pageY : Basics.Float } }"},"Internal.Slider.Model.Geometry":{"args":[],"type":"{ rect : Internal.Slider.Model.Rect, discrete : Basics.Bool, step : Maybe.Maybe Basics.Float, min : Basics.Float, max : Basics.Float }"},"Internal.Slider.Model.Rect":{"args":[],"type":"{ left : Basics.Float, width : Basics.Float }"},"Internal.Tabs.Model.Geometry":{"args":[],"type":"{ tabs : List.List { offsetLeft : Basics.Float, offsetWidth : Basics.Float }, tabBar : { offsetWidth : Basics.Float }, scrollFrame : { offsetWidth : Basics.Float } }"},"Internal.Textfield.Model.Geometry":{"args":[],"type":"{ width : Basics.Float, height : Basics.Float, labelWidth : Basics.Float }"},"Internal.Toolbar.Model.Config":{"args":[],"type":"{ fixed : Basics.Bool, fixedLastrow : Basics.Bool, fixedLastRowOnly : Basics.Bool, flexible : Basics.Bool, useFlexibleDefaultBehavior : Basics.Bool, waterfall : Basics.Bool, backgroundImage : Maybe.Maybe String.String }"},"Internal.Toolbar.Model.Geometry":{"args":[],"type":"{ getRowHeight : Basics.Float, getFirstRowElementOffsetHeight : Basics.Float, getOffsetHeight : Basics.Float }"},"Browser.Dom.Element":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float }, element : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"}},"unions":{"Types.Msg":{"args":[],"tags":{"AdvancedSettingsButtonClicked":[],"RenderButtonClicked":[],"RenderFinished":["Basics.Bool"],"Mdc":["Material.Msg Types.Msg"],"UserChangedTheta":["Basics.Float"],"UserChangedWaviness":["Basics.Float"],"UserChangedLineHeight":["Basics.Float"],"UserChangedStretchX":["Basics.Float"],"UserChangedStretchY":["Basics.Float"],"UserChangedOpacity":["Basics.Float"],"UserChangedContrast":["Basics.Float"],"NewImageLoaded":["Basics.Bool"]}},"Internal.Msg.Msg":{"args":["m"],"tags":{"Dispatch":["List.List m"],"ButtonMsg":["Internal.Index.Index","Internal.Button.Model.Msg m"],"CheckboxMsg":["Internal.Index.Index","Internal.Checkbox.Model.Msg"],"ChipMsg":["Internal.Index.Index","Internal.Chip.Model.Msg m"],"DialogMsg":["Internal.Index.Index","Internal.Dialog.Model.Msg"],"DrawerMsg":["Internal.Index.Index","Internal.Drawer.Model.Msg"],"FabMsg":["Internal.Index.Index","Internal.Fab.Model.Msg"],"GridListMsg":["Internal.Index.Index","Internal.GridList.Model.Msg m"],"IconToggleMsg":["Internal.Index.Index","Internal.IconToggle.Model.Msg"],"MenuMsg":["Internal.Index.Index","Internal.Menu.Model.Msg m"],"RadioButtonMsg":["Internal.Index.Index","Internal.RadioButton.Model.Msg"],"RippleMsg":["Internal.Index.Index","Internal.Ripple.Model.Msg"],"SelectMsg":["Internal.Index.Index","Internal.Select.Model.Msg m"],"SliderMsg":["Internal.Index.Index","Internal.Slider.Model.Msg m"],"SnackbarMsg":["Internal.Index.Index","Internal.Snackbar.Model.Msg m"],"SwitchMsg":["Internal.Index.Index","Internal.Switch.Model.Msg"],"TabsMsg":["Internal.Index.Index","Internal.Tabs.Model.Msg m"],"TextfieldMsg":["Internal.Index.Index","Internal.Textfield.Model.Msg"],"ToolbarMsg":["Internal.Index.Index","Internal.Toolbar.Model.Msg"],"TopAppBarMsg":["Internal.Index.Index","Internal.TopAppBar.Model.Msg"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Internal.Button.Model.Msg":{"args":["m"],"tags":{"RippleMsg":["Internal.Ripple.Model.Msg"],"Click":["Basics.Bool","m"]}},"Internal.Checkbox.Model.Msg":{"args":[],"tags":{"NoOp":[],"Init":["Maybe.Maybe (Maybe.Maybe Internal.Checkbox.Model.State)","Maybe.Maybe Internal.Checkbox.Model.State"],"SetFocus":["Basics.Bool"],"AnimationEnd":[]}},"Internal.Chip.Model.Msg":{"args":["m"],"tags":{"RippleMsg":["Internal.Ripple.Model.Msg"],"Click":["m"]}},"Internal.Dialog.Model.Msg":{"args":[],"tags":{"NoOp":[],"SetState":["Basics.Bool"],"SetOpen":["Basics.Bool"],"AnimationEnd":[]}},"Internal.Drawer.Model.Msg":{"args":[],"tags":{"NoOp":[],"Tick":[],"SetOpen":["( Basics.Bool, Basics.Bool )"]}},"Internal.Fab.Model.Msg":{"args":[],"tags":{"RippleMsg":["Internal.Ripple.Model.Msg"],"NoOp":[]}},"Internal.GridList.Model.Msg":{"args":["m"],"tags":{"Init":["Internal.GridList.Model.Geometry"]}},"Internal.IconToggle.Model.Msg":{"args":[],"tags":{"RippleMsg":["Internal.Ripple.Model.Msg"]}},"Internal.Menu.Model.Msg":{"args":["m"],"tags":{"NoOp":[],"Init":["{ quickOpen : Basics.Bool, index : Maybe.Maybe Basics.Int }","Internal.Menu.Model.Geometry"],"AnimationEnd":[],"Open":[],"Close":[],"Toggle":[],"CloseDelayed":[],"DocumentClick":[],"KeyDown":["Basics.Int","Internal.Menu.Model.Meta","Internal.Menu.Model.Key","Internal.Menu.Model.KeyCode"],"KeyUp":["Internal.Menu.Model.Meta","Internal.Menu.Model.Key","Internal.Menu.Model.KeyCode"],"SetFocus":["Basics.Int"]}},"Internal.RadioButton.Model.Msg":{"args":[],"tags":{"RippleMsg":["Internal.Ripple.Model.Msg"],"NoOp":[],"SetFocus":["Basics.Bool"]}},"Internal.Ripple.Model.Msg":{"args":[],"tags":{"Focus":[],"Blur":[],"Activate0":["String.String","Internal.Ripple.Model.ActivateData"],"Activate":["Internal.Ripple.Model.ActivateData","Result.Result Browser.Dom.Error Browser.Dom.Element"],"Reactivate":["Internal.Ripple.Model.ActivateData","Result.Result Browser.Dom.Error Browser.Dom.Element"],"ActivationEnded":["Basics.Int"],"Deactivate":[],"DeactivationEnded":["Basics.Int"]}},"Internal.Select.Model.Msg":{"args":["m"],"tags":{"Blur":[],"Focus":[],"Change":["String.String"],"RippleMsg":["Internal.Ripple.Model.Msg"]}},"Internal.Slider.Model.Msg":{"args":["m"],"tags":{"NoOp":[],"Init":["Internal.Slider.Model.Geometry"],"Resize":["Internal.Slider.Model.Geometry"],"InteractionStart":["String.String","{ pageX : Basics.Float }"],"KeyDown":[],"Focus":[],"Blur":[],"ThumbContainerPointer":["String.String","{ pageX : Basics.Float }"],"TransitionEnd":[],"Drag":["{ pageX : Basics.Float }"],"Up":[],"ActualUp":[]}},"Internal.Snackbar.Model.Msg":{"args":["m"],"tags":{"Move":["Basics.Int","Internal.Snackbar.Model.Transition"],"Dismiss":["Basics.Bool","Maybe.Maybe m"]}},"Internal.Switch.Model.Msg":{"args":[],"tags":{"SetFocus":["Basics.Bool"],"NoOp":[]}},"Internal.Tabs.Model.Msg":{"args":["m"],"tags":{"NoOp":[],"Dispatch":["List.List m"],"Select":["Basics.Int","Internal.Tabs.Model.Geometry"],"ScrollForward":["Internal.Tabs.Model.Geometry"],"ScrollBack":["Internal.Tabs.Model.Geometry"],"RippleMsg":["Basics.Int","Internal.Ripple.Model.Msg"],"Init":["Internal.Tabs.Model.Geometry"],"SetIndicatorShown":[],"Focus":["Basics.Int","Internal.Tabs.Model.Geometry"]}},"Internal.Textfield.Model.Msg":{"args":[],"tags":{"Blur":[],"Focus":["Internal.Textfield.Model.Geometry"],"Input":["String.String"],"NoOp":[]}},"Internal.Toolbar.Model.Msg":{"args":[],"tags":{"Init":["Internal.Toolbar.Model.Config","Internal.Toolbar.Model.Geometry"],"Resize":["Internal.Toolbar.Model.Config","Internal.Toolbar.Model.Geometry"],"Scroll":["Internal.Toolbar.Model.Config","Basics.Float"]}},"Internal.TopAppBar.Model.Msg":{"args":[],"tags":{"Init":["{ scrollPosition : Basics.Float, topAppBarHeight : Basics.Float }"],"Resize":["{ scrollPosition : Basics.Float, topAppBarHeight : Basics.Float }"],"Scroll":["{ scrollPosition : Basics.Float }"]}},"List.List":{"args":["a"],"tags":{}},"String.String":{"args":[],"tags":{"String":[]}},"Internal.Checkbox.Model.State":{"args":[],"tags":{"Checked":[],"Unchecked":[]}},"Internal.Snackbar.Model.Transition":{"args":[],"tags":{"Timeout":[],"Clicked":[]}},"Browser.Dom.Error":{"args":[],"tags":{"NotFound":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}}}})}});}(this));